			...
			//< par click dans le calendrier 
			  // var title = prompt ("Titre de l'évènement :"); 
		        $('#formEventCustomC').modal('show');
				 //if (title) {
				start = $.fullCalendar.moment(start).format('DD/MM/YYYY HH:mm:ss');
				end = $.fullCalendar.moment(end).format('DD/MM/YYYY HH:mm:ss');
		        $(".datetimepicker").attr('placeholder',start);
		        $(".datetimepicker1").attr('placeholder',end);
